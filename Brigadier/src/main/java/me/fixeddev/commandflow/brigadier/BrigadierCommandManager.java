            ...
            while (iterator.hasNext()) {
                ...
                try {
                    ...
                    if (matchedPlayers.size() > 1) {
                        Component component = getTranslator().translate(Component.translatable("selector.ambiguous").args(Component.text(argument)), accessor);
                    ...
                    Component component = Component.translatable("selector.parse-error").args(Component.text(argument), Component.text(message));
